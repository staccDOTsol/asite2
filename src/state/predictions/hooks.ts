...
import { StatusElementType } from 'views/LimitOrders/components/LimitOrderTable/OrderStatus'
...
export const useBearPs = () => {
  // @ts-ignore
  return useSelector((state: PredictionsState) => state.bearPs)
}
export const useBullPs = () => {
  // @ts-ignore
  return useSelector((state: PredictionsState) => state.bullPs)
}
