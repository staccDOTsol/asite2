...
export const initialState: PredictionsState = {
  bullPs: [{round:0, which:"none", wat:0}],
  bearPs: [{round:0, which:"none", wat:0}],
...
export const predictionsSlice = createSlice({
  ...
  reducers: {
    ...
    setBearPs: (state, action: PayloadAction<any>) => {
      state.bearPs = action.payload
    },
    setBullPs: (state, action: PayloadAction<any>) => {
      state.bullPs = action.payload
    },
